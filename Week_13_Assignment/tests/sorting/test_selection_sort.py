...
def run_sort(array):
    SelectionSort(array, _noop_draw, _noop_wait, _noop_events)
    return array
...
class TestSelectionSort(unittest.TestCase):
    ...
    def test_mutates_in_place(self):
        arr = [3, 1, 2]
        original_ref = arr
        SelectionSort(arr, _noop_draw, _noop_wait, _noop_events)
    ...
    def test_abort_mid_sort(self):
        ...
        result = SelectionSort(arr, _noop_draw, _noop_wait, abort_after_5)
    ...
    def test_benchmark(self):
        ...
        print(f"The selection sort benchmark of sorting {n:,} items took {elapsed:.4f} seconds.")
